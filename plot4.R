...
# Voltage 
plot(x=consumption$formattedDate  , y=as.numeric(levels(consumption$Voltage))[consumption$Voltage] , ylab=paste("Voltage"), xlab="datetime", type="l"  )
...
plot(x=consumption$formattedDate  , y=as.numeric(levels(consumption$Global_reactive_power))[consumption$Global_reactive_power] , ylab=paste("Global reactive power"), xlab="datetime", type="l"  )
